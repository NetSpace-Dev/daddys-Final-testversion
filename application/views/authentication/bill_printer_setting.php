                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-sm-12 col-md-4 col-lg-4 txt_11 print_server_url_div_bill">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="pull-right btn btn-xs btn-success btn-detect-ip-btn" data-target-input="print_server_url_bill" style="font-size: 11px; padding: 2px 8px; line-height: 1.5; background-color: #28a745; border-color: #28a745; color: #fff; margin-right: 5px; float: right;">Auto Detect IP</button>
