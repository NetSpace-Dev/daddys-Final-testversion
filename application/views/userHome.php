...
<?php $language = $this->session->userdata('language'); ?>
    ...
    <div class="wrapper <?=isset($language) && $language=="arabic"?'arabic-lang"':''?>">
        ...
        <aside class="main-sidebar2" >
            <a href="#" class="sidebar-toggle set_collapse" data-status="<?php echo isset($is_collapse) && $is_collapse=="No"?'2':'1'?>" data-toggle="push-menu" role="button" style="display:none;">
                            ...
                            <ul class="treeview-menu" style="">
                                ...
                                <li class="sub_sub">
                                    ...
                                    <ul class="sub-menu" style="display: none;">
                                        ...
                                        <li data-access="update-6" class="menu_assign_class" data-menu__cid="irp_32"><a href="<?php echo base_url()?>setting/customerDisplaySetting">
                                                Customer Display Settings</a></li>
                                        <!-- End Sub Menu -->
                                    </ul>
                                </li>
        ...
        <aside class="main-sidebar" <?=isset($language) && $language=="arabic"?'style="display:none"':''?>>
            ...
            <a href="#" class="sidebar-toggle set_collapse" data-status="<?php echo isset($is_collapse) && $is_collapse=="No"?'2':'1'?>" data-toggle="push-menu" role="button" <?=isset($language) && $language=="arabic"?'style="display:none"':'style="display:none"'?>>
                <span class="sr-only">Toggle navigation</span>
                <span class="inner-circle"></span>
            </a>
            <!-- Sidebar toggle button-->
       ...
       <footer class="main-footer"  <?=isset($language) && $language=="arabic"?'style="margin-left:0px"':''?>>
            <div class="row">
                <div class="col-md-12 ir_txt_center">
                   <a href="https://www.netspace.com" target="_blank" style="text-decoration: none;">Powered by NetSpace ❤</a>
                </div>
            </div>
        </footer>
    </div>
